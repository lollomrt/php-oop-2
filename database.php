<?php
    ...
    $prodotto_6 = new accessorio ('https://www.aquariumline.com/catalog/images/15412_Iy7JqHVtJLbq.jpg', 'cartucce filtranti per filtro easyCrystal', '2,29€', new categoria ('fa-solid fa-fish', 'pesce'), 'materiale espanso', 'ND');
